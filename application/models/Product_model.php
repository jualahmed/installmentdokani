...
class Product_model extends CI_model{
    ...
    {   
        $this->db->select('product_info.product_id, stock_amount,product_info.product_specification,
	...
	function shop_wise_product($product_id, $exclude)
	{
		...
		******************************/
		...
		{				
			...
			foreach ($query -> result() as $field)
			{
				$data[base_url().'index.php/Product/store_in_shelf_entry/'.$field->shelf_no] = $field -> shelf_no;
			}
			return $data;	
		}
