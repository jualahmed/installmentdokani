...
class Report_model extends CI_model{
	...
	public function get_purchase_info_by_multi($receipt_id='',$product_id='',$distributor_id='',$start_date='',$end_date='',$category1='',$company1='')
	{
		...
		$this->db->order_by('warranty_product_list.doc', 'desc');
	...
	public function get_sale_info_by_multi($invoice_id='',$customer_id='',$product_id='',$seller_id='',$start_date='',$end_date='')
	{
	...
	public function installment_report_response($startdate='',$enddate='')
	{
	...
	public function overdueinstallment($date='')
	{
		$this->db->select('sells_log.*,sells_log.id as sid ,all_installment.*,product_info.*,warranty_product_list.*,purchase_receipt_info.*,customer_info.*,users.*');
	...
	************************************************************/
	 ...
	 *********************************************/
	public function stock_status_on_specific_date( $query_date, $current_date )
	{
