						...
						<div class="col-md-12">
							<div class="form-group">
							   <label for="inputEmail3" class="control-label">Name</label>
								<?php 
									echo form_input('unit_name', '','class="form-control unit_name" style="text-transform:uppercase" placeholder="unit Name" autocomplete="off"');
								?>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<input type="hidden" name="unit_id" id="unit_id">
		 				<div class="form-group">
							...
							<?php 
								echo form_input('unit_name', '','class="form-control" id="unit_name" style="text-transform:uppercase" placeholder="unit Name" autocomplete="off"');
							?>
						</div>
					</div>
				</div>
