...
<body> 
	...
	?>
 	<div id ="main_invoice" style="width: 1000px; margin: auto;">
        ...
        <div>
            <b>M/S</b>
           <div><p class="dynamicdata" style="margin-left: 30px;"></p></div>
           <div><p class="dynamicdata" style="margin-top: 30px;margin-left: 30px;"></p></div>
        </div>

        <div>
            <span>Mob:</span><br>
            <span class="fs-i">Please Receve the undermentioned vehicles/with standerd/Extra tools with spare wheel and accessories on the following particulars:</span>
        </div>

        <div>
            <div style="display: flex;margin-top:15px;">
                <div style="width: 29%;"><p class="name">01.&nbsp; Chassis No. </p></div>
                <div style="width: 75%;display: flex;">: <p class="dynamicdata text-right" style="width: 100%;"><?php echo $all->chassisno ?></p></div><br>
            </div>

            <div style="display: flex;width:100%;margin-top:15px;">
                <div style="width: 29%;"><p class="name">02.&nbsp; Engine No. </p></div>
                <div style="width: 75%;display: flex;">:<p class="dynamicdata text-right" style="width: 100%;"> <?php echo $all->engineno ?></p></div><br>
            </div>
        ...
        <div style="border: 1px solid;margin: 15px 0px;">
            <h5 style="padding: 5px 50px 5px 5px;margin-bottom: 30px;">REMARKS:</h5>
        </div>
        ...
        <div style="display:flex;margin-top: 30px;">
            <div style="width: 50%;"><span style="border-top: 1px dotted;">(Sales Department)</span></div>
